  ...
  return ( 
    <div className='fixed flex w-screen h-screen top-0 right-0 justify-center items-center z-50'>
        <div
          ...
          className={`flex flex-col space-y-2 w-[90%] overflow-hidden md:w-[50%] transition-colors duration-300 border-[1px] border-gray-400
                      ${taskFormOpen && goalsExpanded ? 'md:h-[740px] md:min-h-[740px]' 
                      : taskFormOpen && isAssigned ? 'md:h-[625px] md:min-h-[625px]' 
                      :  taskFormOpen ? 'md:h-[65%] md:min-h-[545px]' 
