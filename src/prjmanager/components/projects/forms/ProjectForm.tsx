...
${values.tags.length > 0 ? values.tags.join(' ') : 'No tags specified'}
    ...
    const IsTheButtonDisabled = ({ values, setFieldValue }) => {
        useEffect(() => {
            const isDisabled = 
                                ...
                                >
                                    {({ values, errors, touched, isSubmitting, handleChange, setFieldValue, handleBlur }) => (
                                            <Form className='flex flex-col space-y-8'>
                                                <IsTheButtonDisabled values={values} setFieldValue={setFieldValue} />
                                                {
                                                    nextStep 
                                                    ...
                                                    :  
                                                        <>
                                                            ...
                                                            <div className="flex flex-col space-y-6">
                                                                ...
                                                                <TextField
                                                                    name="endDate"
                                                                    label={ errors.deadline && touched.deadline ? 'EndDate is required' : 'End Date'}
                                                                    type="date"
