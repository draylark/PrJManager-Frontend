...
export const InfoBoxes = () => {
  return (
        ...
        <div className="flex  ml-10 space-x-4 relative animate__zoomIn">
                
            <div className="info-box-shadow info-box bg-[#ffffff26] text-white rounded-extra p-5 h-20 w-60 flex justify-center flex-col ">
            ...
            <div className="info-box-shadow  info-box bg-[#0455b19a] text-white rounded-extra p-5 h-20 w-60 flex justify-center flex-col">
                <div className='flex space-x-2'>
            ...
            <div className="info-box-shadow  info-box bg-[#491ab526] text-white rounded-extra p-5 h-20 w-60 flex justify-center flex-col">
                <div className='flex space-x-2'>
