...
interface TaskHeatMapProps {
  data: CommitCount[];
  commitsDetailsByDay: Map<string, { count: number; commits?: number }>;
  createdAt: string;
}

interface TooltipContentProps {
  formattedDate: string;
  details: { count: number; commits?: number };
}

export const TaskHeatmap: React.FC<TaskHeatMapProps> = ({ data, commitsDetailsByDay, createdAt }) => {
    ...
    const TooltipContent = ({ formattedDate, details }: TooltipContentProps ) => {
      return (
