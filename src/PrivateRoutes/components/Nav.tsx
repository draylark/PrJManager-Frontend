            ...
            <div className='flex flex-col  space-y-6 '>
                ...
                <div className='flex space-x-2 items-center'>
                    <Link to={`personal-area/${username}`}>
                        <img src={getImageOrDefault(photoUrl as string)}  alt="User" className="cursor-pointer h-[65px] w-[65px] rounded-full mr-3 border-[2px] border-transparent hover:border-blue-50 transition-colors duration-200"/>
                    </Link>
